...
export const HeroBanner: React.FC<HeroBannerProps> = ({ title = 'Explore Our Courses', subtitle = 'Master new skills with expert-led courses designed for the modern learner. Start your learning journey today with INFNOVA Academy.', onSearch }) => {
  return (
      ...
      <div className="site-container overlap-search">
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-4 flex items-center gap-3">
          <div className="flex-1 flex items-center gap-3">
            ...
            <input className="flex-1 bg-transparent outline-none text-text-primary text-sm" placeholder="Search courses, instructors..." aria-label="Search courses" onChange={(e) => onSearch?.(e.target.value)} />
          </div>
