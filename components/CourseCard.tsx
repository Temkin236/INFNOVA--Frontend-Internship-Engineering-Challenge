...
export const CourseCard: React.FC<CourseCardProps> = ({ course, compact = false }) => {
  return (
    <Link href={`/courses/${course.id}`} className="block">
      <article className="card-base cursor-pointer hover:shadow-lg transition transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-primary/30">
